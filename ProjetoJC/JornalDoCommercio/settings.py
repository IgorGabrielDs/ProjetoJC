...
https://docs.djangoproject.com/en/5.2/topics/settings/from pathlib import Path
import os
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-uz2%hbo7na4c)@u1ccw=q23yv#crb*zb^gsuzn#nveb^2kgefz'
